Process:
----------------------------
step1 - You have to use a database first.
step2 - In that database "create table userdata(id int primary key auto_increment,firstname varchar(30),lastname varchar(30),email varchar(40),phone varchar(10),dob varchar(10),password varchar(30));"
